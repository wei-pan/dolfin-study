...
class cahnhilliard2d_coordinate_mapping_1: public ufc::coordinate_mapping
{
public:

  cahnhilliard2d_coordinate_mapping_1();

  ~cahnhilliard2d_coordinate_mapping_1() override;
